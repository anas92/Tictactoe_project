...
public class Tictactoe_project extends Application implements Runnable{
	...
	Map<Integer,String> myBoard = new LinkedHashMap<Integer,String>();
...
//        save.setStyle("-fx-color: green;");
        	...
        	load.setStyle("-fx-background-color: yellow;");
        	...
        	load.setOnAction((ActionEvent event) -> {
        		...
        		if(result.isPresent()) {
        			...
        			for (Map.Entry<Integer,String> entry : myData.entrySet()) {
        				...
        				btns.get(key).setStyle("-fx-background-image: url('"+value+".png')");
